...
UX_STEP_NOCB(ux_menu_ready_step, pnn,
             {&C_aptos_logo_16px, "Aptos", "is ready"});
...
// #4 screen: quit
UX_FLOW(ux_menu_main_flow, &ux_menu_ready_step, &ux_menu_settings_step,
...
UX_FLOW(ux_menu_about_flow, &ux_menu_info_step, &ux_menu_version_step,
        &ux_menu_back_step, FLOW_LOOP);

void ui_menu_about() { ui_flow_display(ux_menu_about_flow); }
